...
<v-container fluid class="users-page">
    ...
    <!-- TABLE -->
    <DataTable ref="gatepassTable" api-url="gate-passes/active" :headers="headers" title="Gate Passes" subtitle="Manage all gate passes issued" :items-per-page-options="[10, 25, 50, 100]" :searchable="true" :exportable="true">
                ...
                <v-card class="premium-menu-card" rounded="xl" elevation="0" min-width="220">
                    ...
                    <div class="menu-items">
                        ...
                        <template v-if="item.operation_status !== 'EXPIRED'">
                            ...
                            <div class="premium-menu-item" @click="addVisitorDialog(item)" v-if="item.workflow_status!=='COMPLETED'&&item.workflow_status!=='EXPIRED'">
                                <div class="menu-item-left">
                            ...
                            <div class="premium-menu-item" @click="submitPass(item)" v-if="item.workflow_status=='PENDING_SUBMISSION'">
                                <div class="menu-item-left">
                                    ...
                                    <div>
                                        <div class="menu-item-title">Submit to Gate 1 Security</div>
                                ...
                                <div class="table-toolbar">
                                    <div class="toolbar-actions">
                                        ...
                                        <div v-if="selectedVisitors.length > 0" class="d-flex align-center flex-wrap gap-3 ml-4">
                                            ...
                                            <!-- Approve at Gate 1 -->
                                            <v-btn v-if="user?.current_gate === 'GATE_1' && canBulkApproveAtGate1" class="premium-bulk-btn approve-btn" rounded="xl" elevation="0" @click="openBulkApprove">
                                            ...
                                            <!-- Check In (Gate 2) -->
                                            <v-btn v-if="canBulkCheckInAtGate2" class="premium-bulk-btn checkin-btn" rounded="xl" elevation="0" @click="openBulkCheckIn">
                                                <span class="btn-glow"></span>
                                            ...
                                            <!-- Check Out (Gate 2) -->
                                            <v-btn  v-if="canBulkCheckOutAtGate2" class="premium-bulk-btn checkout-btn" rounded="xl" elevation="0" @click="openBulkCheckOut">
                                                <span class="btn-glow"></span>
                                            ...
                                            <!-- Final Exit (Gate 1) -->
                                            <v-btn v-if="canBulkCheckOutAtGate1" class="premium-bulk-btn final-exit-btn" rounded="xl" elevation="0" @click="openBulkGate1CheckOut">
                                                <span class="btn-glow"></span>
                                                <v-icon start size="20">mdi-exit-to-app</v-icon>
                                                        ...
                                                        <v-card class="premium-menu-card" rounded="xl" elevation="0" min-width="220">
                                                            ...
                                                            <div class="menu-items">
                                                                ...
                                                                <div class="premium-menu-item" @click="approveAtGate1(item)" v-if="user?.current_gate === 'GATE_1' && canApproveAtGate1(item)">
                                                                    <div class="menu-item-left">
                                                                        <div class="menu-item-icon view-bg">
                                                                            <v-icon size="18" class="view-icon"> mdi-shield-check-outline </v-icon>
                                                                        </div>

                                                                        <div>
                                                                            <div class="menu-item-title"> Approve At Gate 1</div>

                                                                            <div class="menu-item-subtitle">Approve the visitor at Gate 1</div>
                                                                        </div>
                                                                    </div>
                                                                    <v-icon size="18" color="#94a3b8"> mdi-chevron-right </v-icon>
                                                                </div>
                                                                <div class="premium-menu-item" @click="checkInVisitorAtGate2Item(item)" v-if="user?.current_gate === 'GATE_2' && canCheckInAtGate2(item)">
                                                                    <div class="menu-item-left">
                                                                        <div class="menu-item-icon create-bg">
                                                                            <v-icon size="18" class="create-icon"> mdi-check-circle</v-icon>
                                                                        </div>

                                                                        <div>
                                                                            <div class="menu-item-title">Check In</div>

                                                                            <div class="menu-item-subtitle">Enter the premises</div>
                                                                        </div>
                                                                    </div>
                                                                    <v-icon size="18" color="#94a3b8"> mdi-chevron-right </v-icon>
                                                                </div>
                                                                <!-- Review Request -->
                                                                <div class="premium-menu-item" @click="checkOutVisitorAtGate2Item(item)" v-if="user?.current_gate === 'GATE_2' && canCheckoutAtGate2(item)">
                                                                    <div class="menu-item-left">
                                                                        <div class="menu-item-icon warning-bg">
                                                                            <v-icon size="18" class="warning-icon"> mdi-exit-to-app </v-icon>
                                                                        </div>

                                                                        <div>
                                                                            <div class="menu-item-title">Check Out At Gate 2</div>

                                                                            <div class="menu-item-subtitle">Exit the premises</div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="premium-menu-item" @click="checkOutVisitorAtGate1Item(item)" v-if="canCheckoutAtGate1(item)">
                                                                    <div class="menu-item-left">
                                                                        <div class="menu-item-icon warning-bg">
                                                                            <v-icon size="18" class="warning-icon">
                                                                                mdi-exit-to-app
                                                                            </v-icon>
                                                                        </div>

                                                                        <div>
                                                                            <div class="menu-item-title">Final Check Out (Gate 1)</div>
                                                                            <div class="menu-item-subtitle">Complete exit from premises</div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <!-- Update Visitor (always available in Pending Submission) -->
...
================================================== -->
    ...
    <v-dialog v-model="companyDialog" max-width="700" persistent transition="dialog-bottom-transition">
        ...
        <v-card class="premium-dialog overflow-hidden" rounded="xl" elevation="0">
            ...
            <div class="dialog-body">
                ...
                <div class="premium-input-group">
                    ...
                    <PaginatedDropdownCompany api-endpoint="/companies" label="" placeholder="Select institution/company" item-title="name" v-model="selectedVisitor.company_id" />
            ...
            <div class="dialog-footer">
                ...
                <v-btn variant="outlined" rounded="xl" height="44" class="px-6" @click="companyDialog = false">
                    Cancel
                </v-btn>

                <v-btn color="primary" rounded="xl" height="44" class="px-6 ml-3 button-color" elevation="0" @click="updateCompany">
                    Save
                </v-btn>
    ...
    <v-dialog v-model="visitorDialog" max-width="760" persistent transition="dialog-bottom-transition">
        ...
        <v-card class="premium-dialog overflow-hidden" rounded="xl" elevation="0">
                ...
                <div class="d-flex align-center justify-space-between flex-wrap position-relative">
                    ...
                    <div class="d-flex align-center">
                        ...
                        <div class="ml-5">
                            ...
                            <div class="dialog-title">
                                {{ visitor.id ? 'Edit Visitor' : 'Create Visitor' }}
                            </div>

                            <div class="dialog-subtitle">
                                Add visitor details for this Gate Pass
                            </div>
                    ...
                    <v-row>
                        ...
                        <v-col cols="12" md="6">
                            <div class="premium-input-group">
                                ...
                                <v-text-field v-model="visitor.first_name" placeholder="First name" variant="solo-filled" flat rounded="xl" hide-details prepend-inner-icon="mdi-account" />
                            </div>
                        </v-col>
                        ...
                        <v-col cols="12" md="6">
                            <div class="premium-input-group">
                                ...
                                <v-text-field v-model="visitor.last_name" placeholder="Last name" variant="solo-filled" flat rounded="xl" hide-details prepend-inner-icon="mdi-account-outline" />
                            </div>
                        </v-col>
                        ...
                        <v-col cols="12" md="6">
                            <div class="premium-input-group">
                                <label class="premium-label">Middle Name</label>

                                <v-text-field v-model="visitor.middle_name" placeholder="Middle name (optional)" variant="solo-filled" flat rounded="xl" hide-details prepend-inner-icon="mdi-account-circle-outline" />
                            </div>
                        </v-col>
                        ...
                        <v-col cols="12" md="6">
                            <div class="premium-input-group">
                                ...
                                <v-text-field v-model="visitor.phone" placeholder="Phone number" variant="solo-filled" flat rounded="xl" hide-details prepend-inner-icon="mdi-phone" />
                            </div>
                        </v-col>
                        ...
                        <v-col cols="12" md="6">
                            <div class="premium-input-group">
                                <label class="premium-label">ID Number</label>

                                <v-text-field v-model="visitor.id_number" placeholder="National ID / Passport" variant="solo-filled" flat rounded="xl" hide-details prepend-inner-icon="mdi-card-account-details-outline" />
                            </div>
                        </v-col>
            ...
            <div class="dialog-footer">
                ...
                <v-btn variant="outlined" rounded="xl" height="48" class="px-8 cancel-dialog-btn" @click="visitorDialog = false">
                    Cancel
                </v-btn>

                <v-btn rounded="xl" height="48" class="px-8 button-color ml-3" elevation="0" @click="addVisitorToGatePass">
    ...
    <InitialSubmissionDialog v-model="submitDialog" title="Submit to Gate 1 for Review" :status="selectedGatePass.workflow_status" :gatePassNumber="selectedGatePass.pass_number" confirm-text="Yes, Submit" cancel-text="No, Cancel" @confirm="submitToGate1FinalReview">
        <template #notice>
            Are you sure you want to submit this gate pass to Gate 1 security for review? This action will notify the security team to review and approve the pass before entry is granted.
        </template>
    </InitialSubmissionDialog>
   
    <checkInDialogshare v-model="checkInGate2Dialog" title="Check In Visitor" :status="selectedGatePass.workflow_status" :gatePassNumber="selectedGatePass.pass_number" confirm-text="Yes, Check In" cancel-text="No, Cancel" @confirm="checkInVisitorAtGate2">
        <template #notice>
            Are you sure you want to check in
            <span class="notice-name">
                {{ selectedVisitor?.first_name }} {{ selectedVisitor?.last_name }}
            </span> at Gate 2? This will finalize their check-in process and grant them access to the premises.
        </template>
    </checkInDialogshare>
    <checkOutAtGate2 v-model="checkOutGate2Dialog" title="Gate 2 Exit Authorization" :status="selectedGatePass.workflow_status" :gatePassNumber="selectedGatePass.pass_number" confirm-text="Yes, Authorize Exit" cancel-text="No, Cancel" @confirm="checkOutVisitorAtGate2">
        <template #notice>
            Are you sure you want to authorize the exit of
            <span class="notice-name">
                {{ selectedVisitor?.first_name }} {{ selectedVisitor?.last_name }}
            </span> through Gate 2? This will complete their visit and log their departure from the premises.
        </template>
    </checkOutAtGate2>

    <checkOutAtgate1 v-model="checkOutGate1Dialog" title="Gate 1 Final Exit Authorization" :status="selectedGatePass.workflow_status" :gatePassNumber="selectedGatePass.pass_number" confirm-text="Yes, Confirm Final Exit" cancel-text="No, Cancel" @confirm="checkOutVisitorAtGate1">
        <template #notice>
            Are you sure you want to authorize the final exit of
            <span class="notice-name">
                {{ selectedVisitor?.first_name }} {{ selectedVisitor?.last_name }}
            </span>
            through Gate 1?

            This action will permanently complete their visit and record their full departure from the premises.
        </template>
    </checkOutAtgate1>
</v-container>
</template>
...
import checkInDialogshare from '../SharedComponents/checkInDialogshare.vue';
import approveAtGate1 from '../SharedComponents/approveAtGate1.vue';
import swtalert from "@/mixins/swtalert";
import InitialSubmissionDialog from "../SharedComponents/InitialSubmissionDialog.vue";
import checkOutAtGate2 from "../SharedComponents/checkOutAtGate2.vue";
import checkOutAtgate1 from "../SharedComponents/checkOutAtgate1.vue";
...
export default {
    ...
    data() {
        return {
            ...
            submitDialog: false,
            submitGate1Dialog: false,
            checkInGate2Dialog: false,
            checkOutGate2Dialog: false,
            checkOutGate1Dialog: false,
            approveGate1Dialog: false,
            loadingStatus: false,
            UserToActivate: {},
            visitor: {},
            statusAction: "",
   ...
   // ============= BULK PERMISSIONS =============
    canBulkApproveAtGate1() {
      if (this.user?.current_gate !== 'GATE_1') return false;
      return this.selectedVisitors.some(id => {
        const item = this.filteredVisitors.find(v => v.id === id);
        return item && this.canApproveAtGate1(item);
      });
    },

    canBulkCheckInAtGate2() {
      if (this.user?.current_gate !== 'GATE_2') return false;
      return this.selectedVisitors.some(id => {
        const item = this.filteredVisitors.find(v => v.id === id);
        return item && this.canCheckInAtGate2(item);
      });
    },

    canBulkCheckOutAtGate2() {
      if (this.user?.current_gate !== 'GATE_2') return false;
      return this.selectedVisitors.some(id => {
        const item = this.filteredVisitors.find(v => v.id === id);
        return item && this.canCheckoutAtGate2(item);
      });
    },

    canBulkCheckOutAtGate1() {
      if (this.user?.current_gate !== 'GATE_1') return false;
      return this.selectedVisitors.some(id => {
        const item = this.filteredVisitors.find(v => v.id === id);
  ...
  canTakeAnyAction(item) {
        ...
        canApproveAtGate1(item) {
            ...
            const gate = item.transactions ?. [0] ?.current_gate;
			const checkin = item.transactions?.[0]?.checkin_status;
            return (
                (status === 'FINAL_REVIEW' || status === 'PARTIALLY_APPROVED' || status === 'PARTIALLY_CHECKED_IN' || status === 'PARTIALLY_EXITED') &&
                gate !== 'GATE_2' &&
                gate !== 'INSIDE' && checkin !== 'EXITING'
            );
		},
		canCheckInAtGate2(item) {
    ...
    return (
		...
		canCheckoutAtGate2(item) {

    const status = this.selectedGatePass.workflow_status;

    const transaction = item.transactions?.[0];

    const gate = transaction?.current_gate;

    const checkin = transaction?.checkin_status;


    return (

        this.user?.current_gate === 'GATE_2' &&
    ...
    const checkout = transaction?.checkin_status;


    return (
        this.user?.current_gate === 'GATE_1' &&
        [
          'PARTIALLY_CHECKED_IN',
            'APPROVED',
            'PARTIALLY_APPROVED',
        ...
        submitGate1Pass(item) {
            this.selectedGatePass = JSON.parse(JSON.stringify(item));
            this.submitGate1Dialog = true;
        },
        approveAtGate1(item) {
            this.selectedVisitor = JSON.parse(JSON.stringify(item));
            this.approveGate1Dialog = true;
        },
        reviewDialog(item) {
            this.selectedVisitor = JSON.parse(JSON.stringify(item));
        ...
        checkInVisitorAtGate2Item(item) {
            this.selectedVisitor = JSON.parse(JSON.stringify(item));
            this.checkInGate2Dialog = true;
        },
        checkOutVisitorAtGate2Item(item) {
            this.selectedVisitor = JSON.parse(JSON.stringify(item));
            this.checkOutGate2Dialog = true;
        },
        checkOutVisitorAtGate1Item(item) {
            this.selectedVisitor = JSON.parse(JSON.stringify(item));
            this.checkOutGate1Dialog = true;
        },
        addVisitorDialog(item) {
            this.selectedGatePass = JSON.parse(JSON.stringify(item));
        ...
        addVisitorToGatePass() {
            const payload = {
                first_name: this.visitor.first_name,
                middle_name: this.visitor.middle_name,
                last_name: this.visitor.last_name,
                phone: this.visitor.phone,
                id_number: this.visitor.id_number,
                company_id: this.visitor.company_id // optional
            }

            axios.post(`/gatepasses/${this.selectedGatePass.id}/visitors`, payload)
                .then(res => {
        ...
        async submitToGate1FinalReview() {

            try {
                const response = await axios.post(`/gate-passes/${this.selectedGatePass.id}/gate1/final-review`);
                ...
                this.submitDialog = false;
                this.showAlert(
                    error.response.data.message || "Failed to submit gate pass",
                    "error"
                );
            }
        },
        async approveVisitorAtGate1() {

            try {
                const response = await axios.post(
                    `/gate-passes/${this.selectedGatePass.id}/gate1/visitors/${this.selectedVisitor.id}/approve`
                );

                this.approveGate1Dialog = false;
                this.viewDialog = false;
        ...
        async checkInVisitorAtGate2() {
            try {
                const response = await axios.post(
                    `/gate-passes/${this.selectedGatePass.id}/visitors/${this.selectedVisitor.id}/check-in`
                );

                this.checkInGate2Dialog = false;
                this.viewDialog = false;
                this.showAlert(response.data.message, "success");
                // reload after short delay
                setTimeout(() => {
        ...
        async checkOutVisitorAtGate2() {
            try {
                const response = await axios.post(
                    `/gate-passes/${this.selectedGatePass.id}/visitors/${this.selectedVisitor.id}/exit`
                );
                this.checkOutGate2Dialog = false;
                this.viewDialog = false;
        ...
        async checkOutVisitorAtGate1() {
            try {
                const response = await axios.post(
                    `/gate-passes/${this.selectedGatePass.id}/visitors/${this.selectedVisitor.id}/check-out`
                );

                this.checkOutGate1Dialog = false;
                this.viewDialog = false;
        ...
        deleteItem() {
            axios
                .delete(`/users/${this.itemToDelete.id}`)
                .then((response) => {
